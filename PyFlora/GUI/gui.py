...
def check():
     if box_username.get() =='Admin' and box_password.get() =='12345':
        prijava.withdraw()
        prazno.withdraw()
...
prazno=tk.Frame()
prazno_l=tk.Label(prazno,text='Niste ulogirani')
prazno_l.pack()

tab_control=ttk.Notebook(glavni_prozor)


prijava=tk.Toplevel(glavni_prozor)
prijava.title('PyFlora')
prijava.geometry('300x150')
...
entry=tk.Button(prijava,text='Prijava', font=("Arial", 10), background='magenta2',command=check)
